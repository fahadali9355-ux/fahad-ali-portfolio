      ...
      <div className="relative z-10 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-4 md:px-8 lg:px-16 py-20">
        ...
        <div className="flex flex-col items-start gap-6">
          ...
          <div className="space-y-4 min-h-[140px]">
            <ScrollReveal direction="up" delay={0.2} duration={1.5}>
            ...
            <ScrollReveal direction="up" delay={0.35}>
              ...
              <p className="text-lg text-white/50 font-medium max-w-md h-8 text-nowrap mt-4">
        ...
        <div className="hidden lg:block">
          <ScrollReveal direction="scale" delay={0.2} duration={1.8}>
